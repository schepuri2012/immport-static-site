# Template: **neutralizing_antibody_titer**

| Name | Value |
| --- | --- |
| Template Type | combined-result |
| Schema Version | 3.33 |
| Standard File Name | experimentSamples.Neutralizing_Antibody_Titer.txt |
...
***
## Combined Result Template: **neutralizing_antibody_titer**
