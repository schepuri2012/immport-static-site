# Template: **neutralizing_antibody_titer_reagents**

| Name | Value |
| --- | --- |
| Template Type | multiple |
| Schema Version | 3.33 |
| Standard File Name | reagents.Neutralizing_Antibody_Titer.txt |
...
| name | - | - | - | - | - | - | - | - | - | - | 
| type | - | - | lk_reagent_type | - | - | - | - | yes | - | Neutralizing Antibody Titer | 
| user_defined_id | yes | - | - | - | - | - | - | - | - | - | 
| weblink | - | - | - | - | - | - | - | - | - | - | 
