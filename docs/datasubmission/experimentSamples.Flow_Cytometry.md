# Template: **flow_cytometry**

| Name | Value |
| --- | --- |
| Template Type | combined-multiple |
| Schema Version | 3.33 |
| Standard File Name | experimentSamples.Flow_Cytometry.txt |
...
| Compensation Or Control File Name(s) | compensation_control_file_names | Separate file names by a semi-colon (;). The file size name limit is 240 characters. | Flow cytometry assay runs include compensation and/or control files. The set of compensation/control files from an assay run should be linked to the experiment sample that is linked to the assayed sample's fcs file. The file size name limit is 240 characters. |
...
| .Fcs Result File | global.result_file_name | The primary output for flow cytometry assays is a file in .fcs format. The file size name limit is 240 characters. | The primary output for flow cytometry assays is a file in .fcs format. The file size name limit is 240 characters. |
...
| biosample_id | yes | - | - | - | - | - | - | - | - | - | 
| biosample_name | - | - | - | - | - | - | - | - | - | - | 
| compensation_control_file_info_ids | - | - | - | - | - | - | yes | - | - | - | 
| compensation_control_file_names | - | yes | - | - | - | - | yes | - | - | - | 
| compensation_flag | - | - | - | - | - | - | - | yes | - | N | 
...
| parameter_number_list | - | - | - | - | - | - | yes | - | - | - | 
| planned_visit_id | - | yes | - | - | - | - | - | - | - | - | 
| pnn_preferred_list | - | - | - | - | - | - | yes | - | - | - | 
| pnn_reported_list | - | - | - | - | - | - | yes | - | - | - | 
| pns_preferred_list | - | - | - | - | - | - | yes | - | - | - | 
| pns_reported_list | - | - | - | - | - | - | yes | - | - | - | 
...
| compensation_control_file_names | case-insensitive-equals | expsample_required | 'Yes' | 
...
| compensation_control_file_names | compensation_control | study_accession | 
...
Table: fcs_header    Type: linkage

| COLUMN NAME | COLUMN TYPE | COLUMN LENGTH | COLUMN LEN CHECK | CLOB CHECK | EMPTY DATA ROW COLUMNS | DATA ROW COLUMN | MULITPLE ROWS | 
|  --- | --- | --- | --- | --- | --- | --- | --- |
| compensation_flag | varchar | 1 | - | - | - | - | - | 
| expsample_accession | varchar | 15 | - | - | - | - | - | 
| fcs_file_name | varchar | 250 | yes | - | - | global.resultfile_name | - | 
| fcs_header_id | integer | - | - | - | - | - | - | 
| fcs_header_text | clob | - | - | yes | - | - | - | 
| fcs_version | float | - | - | - | - | - | - | 
| file_info_id | integer | - | - | - | - | resultfile_name_file_info_id | - | 
| maximum_intensity | float | - | - | - | - | - | - | 
| minimum_intensity | float | - | - | - | - | - | - | 
| number_of_events | integer | - | - | - | - | - | - | 
| number_of_markers | integer | - | - | - | - | - | - | 
| panel_preferred | varchar | 2000 | yes | - | - | - | - | 
| panel_reported | varchar | 2000 | yes | - | - | - | - | 

Table: fcs_header_marker    Type: linkage

| COLUMN NAME | COLUMN TYPE | COLUMN LENGTH | COLUMN LEN CHECK | CLOB CHECK | EMPTY DATA ROW COLUMNS | DATA ROW COLUMN | MULITPLE ROWS | 
|  --- | --- | --- | --- | --- | --- | --- | --- |
| fcs_header_id | integer | - | - | - | - | - | - | 
| parameter_number | integer | - | - | - | - | parameter_number_list | yes | 
| pnn_preferred | varchar | 150 | yes | - | - | pnn_preferred_list | yes | 
| pnn_reported | varchar | 150 | yes | - | - | pnn_reported_list | yes | 
| pns_preferred | varchar | 150 | yes | - | - | pns_preferred_list | yes | 
| pns_reported | varchar | 150 | yes | - | - | pns_reported_list | yes | 
...
| RULE TYPE | RULE NAME | CONDITIONS | DATA ROW COLUMNS | 
|  --- | --- | --- | --- |
| simple type | check-not-contains-case-insensitive | - | ['final.resultfile_name', 'compensation_control_file_names'] | 


| RULE TYPE | RULE NAME | CONDITIONS | DATA ROW COLUMNS | 
|  --- | --- | --- | --- |
| simple type | check-not-contains-case-insensitive | - | ['additional_result_file_names', 'compensation_control_file_names'] | 
...
|  --- | --- | --- | --- | --- | --- | --- |
| set-to-value | Provided Below | [] | [global.determine_file_preferred_info] | [Action = set, Value = Yes] | - | - | 
...
| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| transform-fcs-file | Provided Below | [global.result_file_name] | [] | - | - | - | 
...
| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| determine-fcs-file-info | Provided Below | [global.result_file_name] | [fcs_version, fcs_header_text, panel_reported, number_of_events, number_of_markers, parameter_number_list, pnn_reported_list, pns_reported_list] | - | - | - | 
...
| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| determine-case-insensitive-list | - | [compensation_control_file_names] | [compensation_control_file_names] | - | - | - | 
...
| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| determine-file-info-ids | - | [compensation_control_file_names] | [compensation_control_file_info_ids] | - | - | - | 


| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| add-accession-to-file-info | - | [expsample_accession, compensation_control_file_info_ids] | [] | - | - | - | 


| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| set-file-info | - | [compensation_control_file_names, compensation_control] | [result_schemas] | - | - | - | 


| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| add-data-to-lists | - | [compensation_control_file_info_ids] | [file_info_ids] | - | - | - | 
