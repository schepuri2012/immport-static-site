# Template: **subjecthumans**

| Name | Value |
| --- | --- |
| Template Type | combined-result |
| Schema Version | 3.33 |
| Standard File Name | subjectHumans.txt |
...
| Description | description | The subject description may be used to augment the arm or cohort based description of a subject. | The subject description may be used to augment the arm or cohort based description of a subject. |
| Ethnicity | ethnicity | A list of preferred terms is available. | Please choose from the drop down list. |
...
| Race | race | A list of preferred terms is available. | Please choose from the drop down list. |
| Race Specify | race_specify | This column supports providing subject race descriptions that ImmPort does not support. | If Race='Other', the race should be specified, otherwise leave blank. |
