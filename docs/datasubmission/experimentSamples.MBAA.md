...
| Schema Version | 3.33 |
| Standard File Name | experimentSamples.MBAA.txt |
...
| Plate Type | plate_type | Describe the MBAA plate type used in the assay. | Describe the MBAA plate type used in the assay. |
...
| assay_id | case-insensitive-equals | expsample_required | 'Yes' | 
| dilution_factor | case-insensitive-equals | expsample_required | 'Yes' | 
...
Table: expsample_mbaa_detail    Type: linkage
...
| PROCESS NAME | CONDITIONS | INPUT DATA ROW COLUMNS | OUTPUT DATA ROW COLUMNS | PROCESS RULE | APPEND OUTPUT | SHOW INFORMATION | 
|  --- | --- | --- | --- | --- | --- | --- |
| add-assay-info | - | [source_type, expsample_user_defined_id, expsample_accession, experiment_accession, assay_group_id, assay_id] | [] | - | - | - | 
...
| lk_plate_type | lk_plate_type | database | - | 
|  --- | --- | --- | --- |
|  | XML COLUMNS | name | description | link | 
|  | DATABASE COLUMNS | name | description | link | 
