...
| Schema Version | 3.33 |
| Standard File Name | experimentSamples.CYTOF.txt |
...
| Result File Name | global.result_file_name | The primary output for CYTOF assays is a file in .fcs format. The file size name limit is 240 characters. | The primary output for CYTOF assays is a file in .fcs format. The file size name limit is 240 characters. |
