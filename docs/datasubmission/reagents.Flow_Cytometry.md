# Template: **flow_cytometry_reagents**

| Name | Value |
| --- | --- |
| Template Type | multiple |
| Schema Version | 3.33 |
| Standard File Name | reagents.Flow_Cytometry.txt |
...
| Clone Name | clone_name | Flow cytometry reagents often consist of a monoclonal antibody linked to a fluorescing compound and the antibody binds to the target analyte. | The detector in flow cytometry reagents is often a monoclonal antibody conjugated to a fluorochrome. When there is no antibody in the reagent, enter 'NA'. |
...
| Reporter Name | reporter_name | Flow Cytometry reagents often consist of a monoclonal antibody linked to a fluorescing compound and the fluorochrome provides the signal for the cytometer's detectors. | The reporter in a flow cytometry reagent is the fluorochrome linked to an antibody. When there is no antibody in the reagent, it is the fluorescing agent (e.g. CFSE). |
...
| type | - | - | lk_reagent_type | - | - | - | - | yes | - | Flow Cytometry | 
| user_defined_id | yes | - | - | - | - | - | - | - | - | - | 
| weblink | - | - | - | - | - | - | - | - | - | - | 
